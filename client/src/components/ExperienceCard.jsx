...
const ExperienceCard = ({experience}) => {
  ...
  return (
    <div className="flex gap-2 font-courgette group">
      ...
      <div className="experience-card rounded-lg px-4 pb-2 shadow-md dark:shadow-secondary-light shadow-secondary-dark mb-4 md:group-hover:scale-[1.02] duration-150">
